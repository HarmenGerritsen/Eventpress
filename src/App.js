    ...
    <div className="App">
      ...
      <Modal show={show1} onHide={handleClose1}>
        ...
        <Modal.Footer class="col text-center">
          <button  type="button" class="btn btn-dark" variant="secondary" onClick={handleClose2}>
            Sluiten
          </button>
          <br />
          <p className="white">.</p>
      ...
      <Modal show={show2} onHide={handleClose2}>
        ...
        <Modal.Footer class="col text-center">
          <button  type="button" class="btn btn-dark" variant="secondary">
            Inschrijven
          </button>
          <button  type="button" class="btn btn-dark" variant="secondary" onClick={handleClose1}>
            Sluiten
          </button>
          <br />
          <p className="white">.</p>
