...
import EventAanmaken from "./Components/event_aanmaken.js";
import LoopTable from "./Components/Table.js";
  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <EventAanvragen handleshow5={show5} handlec5={handleClose5} handles6={handleShow6} />
